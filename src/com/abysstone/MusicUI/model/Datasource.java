package com.abysstone.MusicUI.model;
...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:/Users/abysstone/Documents/IdeaProjects/MusicUI/" + DB_NAME;
    ...
    //SELECT * FROM songs WHERE title = "Evil Woman"
    //SELECT * FROM albums WHERE _id = 143
    // SELECT * FROM artists WHERE _id = 36
//Joining
...
//    ORDER BY artists.name, albums.name COLLATE NOCASE ASC
    ...
    public boolean open(){
        try{
            ...
            System.out.println("Could'nt connect to database: " + e.getMessage());
            return false;
        }
    }
...
//            }
//        }
// new resources try blocking lets us get away with the exception closure for statements and resultsets... hence no need for the finally anymore.
